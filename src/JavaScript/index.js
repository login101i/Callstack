...
export const JsExercises = () => {
  ...
  // let exercise = "Write tree methods to clone an array.";
  ...
  // console.log("Clone of array nr 1: ");
  ...
  let exercise =
    "Write a  function which will take an array of numbers and returns the second lowest and second greatest number.";

  // let array = [2, 10, 24, 566, 100, 222];
  ...
  //   result.push(Math.min.apply(null, array), Math.max.apply(null, array));
  ...
  // result.pop();
  // console.log(result);
  // return console.log([result.shift(), result.pop()]);
  // };

  // findNumbers(array);
  // =====================================================================

  // let exercise = "Write a function to get the length of a object.";

  const getObjectLength = (object) => {
    var osize = 0;
    let key;
    for (key in object) {
      if (object.hasOwnProperty(key)) osize++;
    }
    return osize;
  };
  ...
  const objsize = getObjectLength(laptop);
